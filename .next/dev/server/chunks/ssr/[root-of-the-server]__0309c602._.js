...
(()=>{
    const e = new Error("Cannot find module '../lib/features/counter/counterSlice'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
'use client';
...
function StoreProvider({ count, children }) {
    ...
    if (!storeRef.current) {
        storeRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$store$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeStore"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0309c602._.js.map