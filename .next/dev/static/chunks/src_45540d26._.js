...
function ProjectButton(t0) {
    ...
    if ($[0] !== "4c8ba528fb4a9fe94bad0b4ad627972b07b3427e02c4ecb245202d1fd70fa71e") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4c8ba528fb4a9fe94bad0b4ad627972b07b3427e02c4ecb245202d1fd70fa71e";
    }
    const { img, setActiveProjectImage, activeProjectImage, setMouseState } = t0;
    let t1;
    ...
    let t2;
    if ($[5] !== activeProjectImage || $[6] !== handleActivate || $[7] !== img || $[8] !== setMouseState) {
        t2 = ({
            "ProjectButton[<div>.onClick]": (e)=>{
        ...
        })["ProjectButton[<div>.onClick]"];
        $[5] = activeProjectImage;
        $[6] = handleActivate;
        $[7] = img;
        $[8] = setMouseState;
        $[9] = t2;
    ...
    let t5;
    if ($[14] !== handleActivate || $[15] !== t2 || $[16] !== t3 || $[17] !== t4) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function Projects(t0) {
    ...
    if ($[0] !== "3afb2b35ab1fbb0d9d3d7941a264fe3915437d95b8523c653dd6c5f03b1dd40d") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3afb2b35ab1fbb0d9d3d7941a264fe3915437d95b8523c653dd6c5f03b1dd40d";
    }
...
function ProjectDetailsOverlay(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "758b5e5c90898431205ea478c23d21a075678dd65f137beaea7531d8cdb2fdcf") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "758b5e5c90898431205ea478c23d21a075678dd65f137beaea7531d8cdb2fdcf";
    }
...
//# sourceMappingURL=src_45540d26._.js.map