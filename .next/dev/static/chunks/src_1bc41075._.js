...
function Navbar() {
    ...
    if ($[0] !== "0fb85f9c20b6689db4039663b45a77aa79bc6a2fc5c4b3828e8b21167ac53ab7") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0fb85f9c20b6689db4039663b45a77aa79bc6a2fc5c4b3828e8b21167ac53ab7";
    }
...
function ProjectButton(t0) {
    ...
    if ($[0] !== "d32bd98d64acff039a5e6842818c73dda05e6fdf3250f5bbf0fdfa590abf1c41") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d32bd98d64acff039a5e6842818c73dda05e6fdf3250f5bbf0fdfa590abf1c41";
    }
    const { projectData, img, setActiveProjectImage, setMouseState } = t0;
    ...
    let t1;
    if ($[1] !== img || $[2] !== setActiveProjectImage || $[3] !== setMouseState) {
        t1 = ({
        ...
        $[1] = img;
        $[2] = setActiveProjectImage;
        $[3] = setMouseState;
        $[4] = t1;
    } else {
        t1 = $[4];
    }
    const handleActivate = t1;
    let t2;
    if ($[5] !== dispatch || $[6] !== projectData) {
        t2 = ({
            "ProjectButton[handleClick]": (e_0)=>{
                setTimeout({
                    "ProjectButton[handleClick > setTimeout()]": ()=>{
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slices$2f$projectSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openProject"])(projectData));
                    }
                }["ProjectButton[handleClick > setTimeout()]"], 900);
            }
    ...
    if ($[8] !== setMouseState) {
        t3 = ({
            "ProjectButton[<div>.onMouseLeave]": ()=>setMouseState(false)
    ...
    let t5;
    if ($[12] !== handleActivate || $[13] !== handleClick || $[14] !== t3 || $[15] !== t4) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProjectButton, "BJQ1DUn/XFEl2NsQ3DWyHAXfnkY=", false, function() {
    return [
...
function ProjectShowcase(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "9b4d2f1556bdc8dda93cfd3c4568fbf70f60060d78934a2dca763d77c25e34a5") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9b4d2f1556bdc8dda93cfd3c4568fbf70f60060d78934a2dca763d77c25e34a5";
    }
    const { activeProjectImage, mouseState } = t0;
    ...
    let t2;
    if ($[3] !== activeProjectImage || $[4] !== mouseState) {
        t2 = [
            mouseState,
            activeProjectImage
        ];
...
_s(ProjectShowcase, "WZ9wCbYEzFbUyVTkn5kB+i9E9Js=");
_c = ProjectShowcase;
var _c;
...
function Projects(t0) {
    ...
    if ($[0] !== "e992a41fdcfcb2bb0e05cf837a37aa2c770409c8f452340ad6b088e60858f945") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e992a41fdcfcb2bb0e05cf837a37aa2c770409c8f452340ad6b088e60858f945";
    }
    ...
    const [mouseState, setMouseState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t1;
    if ($[1] !== activeProjectImage || $[2] !== mouseState) {
...
_s(Projects, "46jXYE7R9TVMbnBajKryW1n1QVA=");
_c = Projects;
var _c;
...
"[project]/src/components/projects/project_details/Main.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ProjectDetailsOverlay(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "5b33aab99b04e76984e00cab69812d6ad47ec366c8d4d0badf93be257ec0b4b0") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5b33aab99b04e76984e00cab69812d6ad47ec366c8d4d0badf93be257ec0b4b0";
    }
    const { projectName, state } = t0;
    const containerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = [];
    ...
    const barsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(t1);
    let t2;
    let t3;
    if ($[2] !== state) {
        t2 = ({
...
_s(ProjectDetailsOverlay, "uxlIFIMKoCK8dVPphHdFaNFfqFc=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$projects$2f$project_details$2f$Main$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/projects/project_details/Main.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/gsap/index.js [app-client] (ecmascript) <locals>");
;
var _s = __turbopack_context__.k.signature();
...
function Home() {
    ...
    if ($[0] !== "8c10d147bcaf4a93a39806f9dfea5cd4debd6d75860eea9be3b67e0ba8a77155") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8c10d147bcaf4a93a39806f9dfea5cd4debd6d75860eea9be3b67e0ba8a77155";
    }
    ...
    let t3;
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$projects$2f$project_details$2f$Main$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=src_1bc41075._.js.map