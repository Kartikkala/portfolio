...
function Projects(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(13);
    if ($[0] !== "d841dab23cc327ea69552d3ed8fdcef63fd4f9edcd212c018163b05c8b29a42f") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d841dab23cc327ea69552d3ed8fdcef63fd4f9edcd212c018163b05c8b29a42f";
    }
...
function ProjectDetailsOverlay() {
    ...
    if ($[0] !== "0907775f4a82f500f84a9780627798979f8c2b48b994004e097f02d1b549d09b") {
        for(let $i = 0; $i < 45; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0907775f4a82f500f84a9780627798979f8c2b48b994004e097f02d1b549d09b";
    }
